...
Download wt.sh. If you would like to be able to run the program from anywhere, place it in one of your system's "PATH" folders. An example on Debian would be `/home/[username]/.local/bin/`. For a list of folders in your system's PATH, open a command line and type `echo $PATH`. 
